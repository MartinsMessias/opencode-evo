...
export const BashTool = Tool.define("bash", async () => {
  ...
  return {
    description: DESCRIPTION.replaceAll("${directory}", "the scoped working directory")
    ...
    parameters: z.object({
      ...
      workdir: z
        .string()
        .describe(
          `The working directory to run the command in. Defaults to the scoped working directory. Use this instead of 'cd' commands.`,
        )
        .optional(),
      description: z
        .string()
